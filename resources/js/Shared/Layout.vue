<template>
  <div class="min-h-screen flex flex-col text-gray-900">
    ...
    <a
      ...
      class="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-[0_18px_40px_rgba(34,197,94,0.35)] transition-transform hover:scale-105 hover:bg-green-600"
...
const whatsappAriaLabel = computed(() => {
  return whatsappMessage.value ? `Fale conosco pelo WhatsApp: ${whatsappMessage.value}` : 'Fale conosco pelo WhatsApp';
});
